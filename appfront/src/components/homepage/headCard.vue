<template>
    <div class="head-card">
        ...
        <div class="column info">
            <q-badge flat color="primary" >Last Login Time:  {{userInfo.lastLogDate.slice(0, 10)}}</q-badge>
            <q-badge outline color="primary">Number of Visits:  {{userInfo.totalReadCount}}</q-badge>
        </div>
    </div>
