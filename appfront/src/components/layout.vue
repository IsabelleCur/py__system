    ...
    <q-header elevated class="bg-primary text-white header" height-hint="98">
      <q-toolbar>
        ...
        <q-btn-group flat v-if="!userInfo" class="header-options">
          <q-btn class="header-option" outline color="wight" label="Log In" :to="{name:'login'}" />
          <q-btn class="header-option" outline color="wight" label="Sign Up" :to="{name:'register'}" />
        </q-btn-group>
        ...
        <template v-if="userInfo">
          ...
          <q-btn-group flat class="header-options">
            <q-btn class="header-option" outline color="wight" label="Personal Information" @click="handleToHomepage()"/>
            <q-btn class="header-option" outline color="wight" label="goods recommendedation" @click="handleToNewsPage()" />
            <q-btn class="header-option" outline color="wight" label="Log Out" @click="handleLogout()" />
          </q-btn-group>
        </template>
      </q-toolbar>
    </q-header>
